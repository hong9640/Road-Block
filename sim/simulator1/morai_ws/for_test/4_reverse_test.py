...
class AggressivePursuitNode:
    ...
    def __init__(self):
        ...
        # NOTE: 이 부분이 Ego-0이 Ego-2를 추적하도록 수정되었습니다.
        # Ego(ego-0)의 상태는 추격 차량(pursuer)이고, Ego-2의 상태는 추격 당하는 차량(target)입니다.
        ...
        self.ctrl_pub = rospy.Publisher('/ctrl_cmd', CtrlCmd, queue_size=1) # Ego-2의 제어 명령을 발행하도록 수정
        ...
        rospy.loginfo("Ego가 Ego-2를 추격하는 공격적 최단경로 추격 노드 시작.")
