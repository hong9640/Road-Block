...
class FollowEgo2Node:
    def __init__(self):
        rospy.init_node('follow_ego4_node')

        self.ctrl_pub = rospy.Publisher('/Ego-4/ctrl_cmd', CtrlCmd, queue_size=1)

        rospy.Subscriber('/Ego-4/Ego_topic', EgoVehicleStatus, self.ego_status_callback)
        ...
        self.MAX_VELOCITY = 40.0        # 40 kph ≈ 11.11 m/s
